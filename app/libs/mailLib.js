                ...
                <div>
                    <div class="container">
                        ...
                        <div class="card card-1">
                            ...
                            <br>
                            <p class="text-center">Please click on the <a href="http://localhost:8000/change-password/${userId}">Link</a> to change password</p>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="card card-1">
                            ...
                            <br>
                            <p class="text-center">${name} wants you to checkout <a href="http://localhost:8000?userId=${userId}">ToDo</a> app.</p>
                        </div>
                    </div>
                </div>
                <br>
